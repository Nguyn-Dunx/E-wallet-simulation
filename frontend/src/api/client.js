...
export const authApi = {
  ...
  resetPasswordCreateOtp: (body) =>
    post("/auth/users/reset-password/create-otp", body),
  resetPasswordVerifyOtp: (body) =>
    post("/auth/users/reset-password/verify-otp", body),
  resetPasswordConfirm: (body) =>
    post("/auth/users/reset-password/confirm", body),
